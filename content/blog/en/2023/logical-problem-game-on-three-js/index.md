...
We were joking that it sounds like a good atmospheric 3D game. Many years later while trying [Three.js](https://threejs.org) I implemented such a game and I'm introducing to you it, so you can solve the described problem and even prove it in the virtual reality of the game. The source code is available [here](https://github.com/underoot/game-train-with-light-bulbs), but be careful because it's mostly spaghetti code.
